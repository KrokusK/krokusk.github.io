            ...
            <div class="animated bounceInTop" >
                ...
                <div class="content-main">
                    <div class="row">
                        ...
                        <?php $form = ActiveForm::begin(['id' => 'form-user-profile', 'action' => Yii::$app->urlManager->createUrl('site/profile')]); ?>

                            <div class="col-sm-6 col-md-4 col-lg-4">
                                <div class="thumbnail">
                                        <img src="<?= Html::encode("{$model->avatar}") ?>" alt="Image">
                                        <?php echo $form->field($model, 'imageFile')->fileInput()->hint('Пожалуйста, загрузить ваш аватар')->label('Аватар'); ?>
                                </div>
                            </div>
