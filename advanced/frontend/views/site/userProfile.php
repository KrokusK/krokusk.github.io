...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 col-lg-8">
            <p><a href="/site/index" class="btn btn-default" role="button">Объявления</a> / <a href="/site/profile" class="btn btn-default" role="button">Личный кабинет</a></p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 col-lg-12">
            ...
            <div class="animated bounceInTop" >
                ...
                <div class="content-main">
                    <div class="row">
                        ...
                        <?php $form = ActiveForm::begin(['id' => 'form-user-profile', 'action' => Yii::$app->urlManager->createUrl('site/profile'), 'validationUrl' => Yii::$app->urlManager->createUrl('site/profile-validate')]); ?>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4">
                                <div class="thumbnail">
                                        <img src="<?php echo Html::encode("{$model->avatar}") ?>" alt="Image" style="height:170px; width:auto; max-width:170px;">
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-2 col-lg-2 col-md-offset-10 col-lg-offset-10">
