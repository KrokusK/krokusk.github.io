                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="thumbnail">
                                            <div class=" view-btn text-center">
                                                ...
                                                <?php echo $form->field($modelPhotoAd, 'imageFiles[]')->fileInput(['class' => 'form-control', 'multiple' => true])->hint('Пожалуйста, загрузите фотографии (не более 3-х фотографий)')->label('Фотографии'); ?>
                                            </div>
                                        </div>
