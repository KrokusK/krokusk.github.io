...
class PhotoAd extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['imageFiles'], 'file', 'skipOnEmpty' => false, 'maxFiles' => 3,'mimeTypes' => ['image/gif', 'image/jpeg', 'image/pjpeg', 'image/png'], 'extensions' => ['gif', 'jpg', 'jpeg', 'png'], 'maxSize' => 10*1024*1024, 'message' => 'Файл не соответствует требованиям'],
        ];
    }
